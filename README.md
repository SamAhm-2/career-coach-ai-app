# career-coach-ai-app
AI-powered career coaching app using Amazon Q Business — automates CV skill-gap analysis, training recommendations, and course access control via S3 and IAM Identity Center.
